...
public class VersionController {
  ...
  static final Summary REQUEST_LATENCY = Summary.build().quantile(0.5,0.05)
      .quantile(0.95,0.05).name("requests_latency_seconds").help("Request latency in seconds.").register();
